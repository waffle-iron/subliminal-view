...
function! airline#extensions#tabline#formatters#base#format(bufnr, buffers)
  let _ = ''
  ...
  return airline#extensions#tabline#formatters#base#wrap_name(a:bufnr, _)
endfunction

function! airline#extensions#tabline#formatters#base#wrap_name(bufnr, buffer_name)
