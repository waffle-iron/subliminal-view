...
class SearchApp(App):
    ...
    def on_stop(self):
        p = Popen(['vim', '--servername', sys.argv[1],
    ...
    def build(self):
        ...
        Window.clearcolor = (0.227, 0.227, 0.227, 1)

        self.root = GridLayout(cols=5, padding=(widgetspacing, 5),
                               spacing=(widgetspacing, 0))

        textinput = TextInput(id='textinput', font_size=11, font_name=dejavu,
        ...
        button_find_previous = Button(text='Find Prev', font_size=11,
                                      font_name=dejavu, width=buttonwidth,
                                      background_color=(0.55, 0.55, 0.55, 1))
        ...
        button_close = Button(text='x', font_size=11, font_name=dejavu,
                              background_color=(0.55, 0.55, 0.55, 1),
                              width=buttonwidth)
